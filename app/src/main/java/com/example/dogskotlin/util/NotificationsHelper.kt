...
import com.example.dogskotlin.view.MainActivity
...
class NotificationsHelper(val context: Context) {
    ...
    fun createNotification(){
        ...
        val icon =BitmapFactory.decodeResource(context.resources, R.drawable.dog_icon1)


        val notification = NotificationCompat.Builder(context, CHANNEL_ID)
            .setSmallIcon(R.drawable.dog_icon1)
            .setLargeIcon(icon)
